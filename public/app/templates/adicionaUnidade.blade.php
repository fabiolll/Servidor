...
<div class="container">
    ...
    <a class="list-group-item list-group-item-success" id="mensagem" style="display: none; margin-left: 380px" ></a>
     ...
     <a class="list-group-item list-group-item-danger" id="mensagemErro" style="display: none; margin-left: 450px"></a>
      ...
      <form class="form-signin" id="formAdicionaUnidade" style="margin-top: 50px">
        <h2 class="form-signin-heading">Adiciona Unidade </h2>
  ...
  <div class="row">
            ...
            <div class="col-md-9"> 
                <input  style ="width: 300px; margin-left: 30px" id="endereco" maxlength="45" class="form-control" placeholder="Endereço"  required>
            </div>
          ...
          <div class="row"  style="margin-top: 5px">
            ...
            <div class="col-md-10"> 
                <input  value="" style ="width: 300px; margin-left: 60px" id="contato" style="margin-bottom: 10px" class="form-control" placeholder="Contato. Ex.: (99) 9999-9999" required >
            </div>
          ...
          <div class="row"  style="margin-top: 5px">
            ...
            <div class="col-md-10"> 
             <input value="" style ="width: 300px;  margin-left: 60px" maxlength="10" id="hora_abertura" style="margin-bottom: 10px" class="form-control" placeholder="Hora de abertura. Ex.: 12:00:00 hs"" required >
            </div>
          ...
          <div class="row"  style="margin-top: 5px">
            ...
            <div class="col-md-9"> 
                 <input value="" style ="width: 300px; ; margin-left: 30px" id="hora_fechamento" style="margin-bottom: 10px" class="form-control" placeholder="Hora de fechamento. Ex.: 12:00:00  hs" required>
            </div>
 ...
 <div class="row"  style="margin-top: 15px">
        ...
        <div class="col-md-6" > 
              <button type="submit" id="btnAdicionaUnidade"  class="btn btn-lg  btn-block">Salvar</button>
             </div>

             <div class="col-md-6" > 
              <button type="button" onclick="voltar({{$cod_empresa}})" id="btnVoltar" class="btn btn-lg  btn-block">Voltar</button>
             </div>
