...
<div class="container">
      ...
      <form class="form-signin" id="formLoginAdministrador">
        <h2 class="form-signin-heading" style="margin-bottom: 25px">Faça seu login (Administrador)</h2>
         ...
         <div class="container">
            ...
            <div class="col-md-10"> 
                <input id="login" maxlength="45" class="form-control" placeholder="Por favor, digite o login" required autofocus>
            </div>
